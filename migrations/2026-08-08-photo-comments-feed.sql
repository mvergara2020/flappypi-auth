...
-- Run this migration before deploying the matching Worker revision.
-- The pre-comment table definition makes fresh databases safe even if this
-- file is encountered before platform-local.sql; ALTER then adds the new field.
